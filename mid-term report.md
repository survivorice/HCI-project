...
#### 生成导出现版本的apk包
 ...
 ## 未完成工作内容
   1. 关键词的提取与分析
      对语音识别的测试结果进行划分 通过上述划分对于语音处理返回的data进行更精细的辨认 筛选出关键信息 传回给模型 在模型上显示
   2. 交互逻辑实现
   3. GUI的美化以及更加符合HCI思想
      根据辨认的结果，在UI界面显示可能的关键词，对关键词添加选择功能。APP界面多场景设计，界面的美观优化
      
  ## 迭代计划
  11-12周：筛选出关键信息 添加选择功能

  13-14周：App界面多场景设计，界面的美观优化
